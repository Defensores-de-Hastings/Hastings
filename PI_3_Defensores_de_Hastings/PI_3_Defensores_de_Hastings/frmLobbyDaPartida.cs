...
namespace PI_3_Defensores_de_Hastings
{
    public partial class frmLobbyDaPartida : Form
    {
        ...
        // Static dictionary for performance - avoids recreation on every call
        private static readonly Dictionary<string, string> _personagensDict = new Dictionary<string, string>
        {
            { "A", "Adilson Konrad" }, { "B", "Beatriz Paiva" }, { "C", "Claro" }, { "D", "Douglas Baquiao" },
            { "E", "Eduardo Takeo" }, { "G", "Guilherme Rey" }, { "H", "Heredia" }, { "K", "Kelly Kiyumi" },
            { "L", "Leonardo Takuno" }, { "M", "Mario Toledo" }, { "Q", "Quintas" }, { "R", "Ranulfo" },
            { "T", "Toshio" }
        };
        ...
        private Dictionary<string, string> GetPersonagensDict() => _personagensDict;
